...
namespace CitiesManager.Core.Services
{
    public class JwtService : IJwtService
    {
        ...
        public async Task<AuthenticationResponse> CreateJwtToken(ApplicationUser user)
        {
            ...
            JwtSecurityToken tokenGenerator = new JwtSecurityToken(_configuration["Jwt:Issuer"], _configuration["Jwt:Audience"], claims, expires: expirationTime, signingCredentials: signingCredentials);
            ...
            return new AuthenticationResponse() { Token = token,Email=user.Email, PersonName=user.PersonName,Expiration= expirationTime, RefreshToken = GenerateRefreshToken(),
